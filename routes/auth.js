...
//       if (err) {
//         return res.status(500).json({ msg: 'There was an error signing up.' });
//       }
//       // username is already taken
//       if (user.length != 0) {
...
//             if (error) { return res.status(500).json({ msg: 'There was an error signing up.' }); }
//             // auto create stats for user
//             const stats = new Stats({
//               intervalsCorrect: {'b2': 0,'2': 0,'b3': 0,'3': 0,'4': 0,'b5': 0,'5': 0,'b6': 0,'6': 0,'b7': 0,'7': 0,'8': 0},
//               intervalsWrong: {'b2': 0,'2': 0,'b3': 0,'3': 0,'4': 0,'b5': 0,'5': 0,'b6': 0,'6': 0,'b7': 0,'7': 0,'8': 0},
...
//               if (err) { return res.status(500).json({ msg: 'There was an error signing up.' }); }
//               // auto create goals for user
//               const goals = new Goals({
//                 intGoal: 0,
//                 noteGoal: 0,
...
//                 if (err) { return res.status(500).json({ msg: 'There was an error signing up.' }); }
//                 return res.status(200).json({ token, stats, goals });
//               });
//             });
//           });
//         });
